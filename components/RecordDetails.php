...
class RecordDetails extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'rainlab.backpack::lang.components.details_title',
            'description' => 'rainlab.backpack::lang.components.details_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'modelClass' => [
                'title'       => 'rainlab.backpack::lang.components.details_model',
                'type'        => 'dropdown',
                'showExternalParam' => false
            ],
            'identifierValue' => [
                'title'       => 'rainlab.backpack::lang.components.details_identifier_value',
                'description' => 'rainlab.backpack::lang.components.details_identifier_value_description',
                'type'        => 'string',
                'default'     => '{{ :id }}',
                'validation'  => [
                    'required' => [
                        'message' => Lang::get('rainlab.backpack::lang.components.details_identifier_value_required')
                    ]
                ]
            ],
            'modelKeyColumn' => [
                'title'       => 'rainlab.backpack::lang.components.details_key_column',
                'description' => 'rainlab.backpack::lang.components.details_key_column_description',
                'type'        => 'autocomplete',
                'default'     => 'id',
                'validation'  => [
                    'required' => [
                        'message' => Lang::get('rainlab.backpack::lang.components.details_key_column_required')
                    ]
                ],
                'showExternalParam' => false
            ],
            'displayColumn' => [
                'title'       => 'rainlab.backpack::lang.components.details_display_column',
                'description' => 'rainlab.backpack::lang.components.details_display_column_description',
                'type'        => 'autocomplete',
                'depends'     => ['modelClass'],
                'validation'  => [
                    'required' => [
                        'message' => Lang::get('rainlab.backpack::lang.components.details_display_column_required')
                    ]
                ],
                'showExternalParam' => false
            ],
            'notFoundMessage' => [
                'title'       => 'rainlab.backpack::lang.components.details_not_found_message',
                'description' => 'rainlab.backpack::lang.components.details_not_found_message_description',
                'default'     => Lang::get('rainlab.backpack::lang.components.details_not_found_message_default'),
                'type'        => 'string',
                'showExternalParam' => false
            ]
        ];
