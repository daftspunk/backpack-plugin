...
use RainLab\Backpack\Classes\ComponentHelper;
use SystemException;
use Exception;
...
class RecordList extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'rainlab.backpack::lang.components.list_title',
            'description' => 'rainlab.backpack::lang.components.list_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'modelClass' => [
                'title'       => 'rainlab.backpack::lang.components.list_model',
                'type'        => 'dropdown',
                'showExternalParam' => false
            ],
            'scope' => [
                'title'       => 'rainlab.backpack::lang.components.list_scope',
                'description' => 'rainlab.backpack::lang.components.list_scope_description',
                'type'        => 'dropdown',
                'depends'     => ['modelClass'],
                'showExternalParam' => false
            ],
            'displayColumn' => [
                'title'       => 'rainlab.backpack::lang.components.list_display_column',
                'description' => 'rainlab.backpack::lang.components.list_display_column_description',
                'type'        => 'autocomplete',
                'depends'     => ['modelClass'],
                'validation'  => [
                    'required' => [
                        'message' => Lang::get('rainlab.backpack::lang.components.list_display_column_required')
                    ]
                ]
            ],
            'noRecordsMessage' => [
                'title'        => 'rainlab.backpack::lang.components.list_no_records',
                'description'  => 'rainlab.backpack::lang.components.list_no_records_description',
                'type'         => 'string',
                'default'      => Lang::get('rainlab.backpack::lang.components.list_no_records_default'),
                'showExternalParam' => false,
            ],
            'detailsPage' => [
                'title'       => 'rainlab.backpack::lang.components.list_details_page',
                'description' => 'rainlab.backpack::lang.components.list_details_page_description',
                'type'        => 'dropdown',
                'showExternalParam' => false,
                'group'       => 'rainlab.backpack::lang.components.list_details_page_link'
            ],
            'detailsKeyColumn' => [
                'title'       => 'rainlab.backpack::lang.components.list_details_key_column',
                'description' => 'rainlab.backpack::lang.components.list_details_key_column_description',
                'type'        => 'autocomplete',
                'depends'     => ['modelClass'],
                'showExternalParam' => false,
                'group'       => 'rainlab.backpack::lang.components.list_details_page_link'
            ...
            'detailsUrlParameter' => [
                'title'       => 'rainlab.backpack::lang.components.list_details_url_parameter',
                'description' => 'rainlab.backpack::lang.components.list_details_url_parameter_description',
                'type'        => 'string',
                'default'     => 'id',
                'showExternalParam' => false,
                'group'       => 'rainlab.backpack::lang.components.list_details_page_link'
            ...
            'recordsPerPage' => [
                'title'             => 'rainlab.backpack::lang.components.list_records_per_page',
                'description'       => 'rainlab.backpack::lang.components.list_records_per_page_description',
                'type'              => 'string',
                'validationPattern' => '^[0-9]*$',
                'validationMessage' => 'rainlab.backpack::lang.components.list_records_per_page_validation',
                'group'             => 'rainlab.backpack::lang.components.list_pagination'
            ],
            'pageNumber' => [
                'title'       => 'rainlab.backpack::lang.components.list_page_number',
                'description' => 'rainlab.backpack::lang.components.list_page_number_description',
                'type'        => 'string',
                'default'     => '{{ :page }}',
                'group'       => 'rainlab.backpack::lang.components.list_pagination'
            ],
            'sortColumn' => [
                'title'       => 'rainlab.backpack::lang.components.list_sort_column',
                'description' => 'rainlab.backpack::lang.components.list_sort_column_description',
                'type'        => 'autocomplete',
                'depends'     => ['modelClass'],
                'group'       => 'rainlab.backpack::lang.components.list_sorting',
                'showExternalParam' => false
            ],
            'sortDirection' => [
                'title'       => 'rainlab.backpack::lang.components.list_sort_direction',
                'type'        => 'dropdown',
                'showExternalParam' => false,
                'group'       => 'rainlab.backpack::lang.components.list_sorting',
                'options'     => [
                    'asc'     => 'rainlab.backpack::lang.components.list_order_direction_asc',
                    'desc'    => 'rainlab.backpack::lang.components.list_order_direction_desc'
                ]
            ]
        ];
    }
    ...
    public function getDetailsPageOptions()
    {
        ...
        $pages = [
            '-' => Lang::get('rainlab.backpack::lang.components.list_details_page_no')
        ] + $pages;
    ...
    public function getScopeOptions()
    {
        ...
        $result = [
            '-' => Lang::get('rainlab.backpack::lang.components.list_scope_default')
        ];
